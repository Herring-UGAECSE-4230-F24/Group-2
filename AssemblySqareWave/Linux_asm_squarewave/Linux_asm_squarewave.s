...
On_time     .req r8 @ Time Square Wave is high
Off_time    .req r9 @ Time Square Wave is low
...
delay1:
    ldr     On_time, =1000000000    @ Time LED is ON
l1: subs    On_time, On_time, #1    @ On_time = On_time - 1
    bne     l1
    mov     pc, lr                  @ return to caller

delay2:
    ldr     Off_time, =1000000000   @ Time LED is OFF
l2: subs    Off_time, Off_time, #1  @ Off_time = Off_time - 1
    bne     l2
    mov     pc, lr                  @ return to caller
